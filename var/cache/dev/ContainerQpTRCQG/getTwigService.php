...
class getTwigService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'\\src\\Service\\ServiceNewsletter.php';
        ...
        $instance->addGlobal('userRepository', ($container->privates['App\\Repository\\UserRepository'] ?? $container->load('getUserRepositoryService')));
        $instance->addGlobal('commandeRepository', ($container->privates['App\\Repository\\CommandeRepository'] ?? $container->load('getCommandeRepositoryService')));
        $instance->addGlobal('serviceCommand', ($container->privates['App\\Service\\ServiceCommande'] ?? $container->load('getServiceCommandeService')));
        $instance->addGlobal('serviceNewsletter', new \App\Service\ServiceNewsletter(($container->services['form.factory'] ?? $container->load('getForm_FactoryService'))));
