...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ContactFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/NewsletterFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/PaniersFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ProducteursFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ProduitsFixtures.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\ContactFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\NewsletterFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\PaniersFixtures(), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\ProducteursFixtures(), 'groups' => []], 5 => ['fixture' => new \App\DataFixtures\ProduitsFixtures(), 'groups' => []], 6 => ['fixture' => new \App\DataFixtures\UserFixtures(($container->services['security.password_encoder'] ?? $container->load('getSecurity_PasswordEncoderService'))), 'groups' => []]]);
